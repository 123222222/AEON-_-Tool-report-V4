import os
import datetime
from config import REPORT_FORM_DIR, SITES_CONFIG
...
def get_report_text(file_id: str, fname: str, is_no_error: bool = False) -> str:
    """
